      ...
      >
        ...
        <div className="w-2/5">
          ...
          <textarea
            ...
            onChange={handleInputChange}
            className="w-full px-4 py-2 h-44 rounded-lg border border-gray-700 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all resize-none mt-4"
            required
          />
          <button
            type="submit"
            className="w-full mt-10 bg-emerald-500  hover:bg-emerald-600 text-white font-semibold py-3 rounded-lg transition-all duration-200 "
          >
            Create Task
          </button>
        </div>
